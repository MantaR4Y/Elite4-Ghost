...
function foundMe() {
  document.getElementById("trevenant").src = "images/trevenantfoundme.png";
  const trevenantSound = new Audio("sounds/TrevenantCry.mp3");
  trevenantSound.play();
  music.pause();
  setTimeout(function () {
    begintext();
...
function nextroom() {
  window.location.href = "aegislash.html";
}
