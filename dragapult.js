...
function foundMe() {
  document.getElementById("dragapult").src = "images/dragapultfoundme.png";
  const dragapultSound = new Audio("sounds/DragapultCry.mp3");
  dragapultSound.play();
  music.pause();
  setTimeout(function () {
    begintext();
...
//when clicking one of the two dreepy they explode and u restart
function foundWrongMe() {
  document.getElementById("dreepy").src = "images/explosion.jpg";
  document.getElementById("dreepy2").src = "images/explosion.jpg";
  const dreepySound = new Audio("sounds/explosion.mp3");
  dreepySound.play();
  music.pause();
  setTimeout(function () {
    refreshPage();
